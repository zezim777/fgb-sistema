...
// --- NOVOS MODAIS DE PERFIL E CONFIGURAÇÃO ---
...
function salvarPerfil() {
    ...
    .then(() => { 
        alert("✅ Identidade atualizada no FGB Cloud!"); 
        fecharModalPerfil(); 
    });
}
...
// --- 3. LÓGICA DE TELAS E AUTENTICAÇÃO INTEGRAL MANTIDA ---
...
// --- FUNÇÕES DE LICITAÇÃO INTEGRAIS MANTIDAS ---
...
function limparLixeiraPermanente() {
    ...
    if(confirm("ATENÇÃO COORDENADOR: Tem certeza que deseja apagar permanentemente a lixeira do setor?")) {
